     ...
     </View>
  {
     this.state.loaded?(
   ...
   
        {
            ...
            return (
               <Ripple onPress={() => this.props.nav.push("full",{views:item.views,title:this.checkTitle(item),photo:item.poster,des:item.description,imdb:this.checkImdb(item),year:item.release_date,key:item.id,titleEn:item.title_en})}>    
